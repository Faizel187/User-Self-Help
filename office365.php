...
$title = 'Nkgwete IT Solutions | Help Center';
$content = '
...
var key = 'AIzaSyDSikjPRYQ-xonahfG4KFqCFV6N5z9JVuc';
...
var playlistId = 'PL52PzG6WjwrXRZugJyclSPLg313yjeSJM';
...
function mainVid(id) {
	$('#video').html(`
				<iframe width="100%" height="395" margin="auto" src="https://www.youtube.com/embed/${id}" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			`);
}
...
function resultsLoop(data) {
	...
	$.each(data.items, function (i, item) {
		...
		$('main').append(`
						<article style="display: flex;" class="item" data-key="${vid}">
